...
import org.usfirst.frc.team5542.robot.commands.dropper.DropperDown;
import org.usfirst.frc.team5542.robot.commands.dropper.DropperUp;
...
public class OI {
	...
	public OI(){
		...
		button5.whileActive(new DropperUp());
		
		button6 = new JoystickButton(stick, 6);
		button6.whileActive(new DropperDown());
	}
